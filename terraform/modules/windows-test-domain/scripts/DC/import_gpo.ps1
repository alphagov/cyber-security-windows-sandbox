...
$OU = "ou=Domain Controllers,$env:PATHS"
...
$OU = "ou=Workstations,$env:PATHS"
$OU1 = "ou=Domain Controllers,$env:PATHS"
$OU2 = "ou=Servers,$env:PATHS"
...
Remove-GPLink -Name "Windows Event Forwarding" -Target "OU=Servers,$env:PATHS"
