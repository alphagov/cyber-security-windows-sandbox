...
Add-Computer -DomainName "SHIRE" -Server $env:DOMAIN_CONTROLLER_IP -OUPath "OU=Servers,{{paths}}" -Credential $Credential -Force -Options JoinWithNewName,AccountCreate
